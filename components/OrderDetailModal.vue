 ...
 -->
              ...
              <div class="flex justify-end gap-3">
                ...
                <button
                  ...
                  class="inline-flex items-center justify-center rounded-md border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2"
                >
                  <svg
...
const emit = defineEmits<{
  ...
  (e: "delete", order: typeof props.order): void;
}>();
