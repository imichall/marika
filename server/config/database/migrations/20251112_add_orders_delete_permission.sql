-- Přidání oprávnění 'delete' pro objednávky
-- Tato migrace zajistí, že oprávnění existuje a všichni admini ho mají defaultně

-- 1. Přidání oprávnění do permissions tabulky (pokud ještě neexistuje)
...
-- 2. Přidání oprávnění všem admin uživatelům (pokud ho ještě nemají)
...
-- 3. Aktualizace update_user_role funkce, aby zahrnovala 'delete' pro adminy
